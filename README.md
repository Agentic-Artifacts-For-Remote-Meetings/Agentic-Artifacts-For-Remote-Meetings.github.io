...
```
cd existing_repo
git remote add origin https://git.scc.kit.edu/h-lab/research/seitz_julia_slr-morph-box.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.scc.kit.edu/h-lab/research/seitz_julia_slr-morph-box/-/settings/integrations)
